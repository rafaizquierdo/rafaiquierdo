      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center">
          <div className="mb-6 md:mb-0 text-center md:text-left">
            ...
            <p className="text-gray-500">Constructor de negocio tecnológico que une tecnología, personas y resultados.</p>
          </div>
        ...
        <div className="max-w-7xl mx-auto mt-8 pt-8 border-t border-gray-200 text-center text-sm text-gray-400">
          <p>&copy; {currentYear} Rafael Izquierdo. Todos los derechos reservados.</p>
        </div>
      </div>
    </footer>
  );
